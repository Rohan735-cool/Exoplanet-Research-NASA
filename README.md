...
|------|-------------|-------------|
| ![KDE](fulton_gap.png) | Radius density (KDE, bw=0.2) | Dip at 1.5–2.0 R⊕ (red zone) |
| ![Scatter](radius_mass.png) | Log radius vs stellar mass | Transit bias for R<4 R⊕ |
| ![Orbital](orbital_hist.png) | Log orbital period histogram | Hot Jupiters cluster <10 days |
